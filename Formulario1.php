...
<body id="fondoMain">
    ...
    <div class="container text-center">
        <h3 class="letra3"> Formulario 1 </h3>
        <div class="container">
		  	<h1 class="text-light brand mt-2  text-center h1inicio">
	...
	<main>
		...
		<div class="container2">
		  	<h1 class="text-light brand mt-2  text-center">			
			Documentos que debe entregar al momento de inscribirlo(a) COMPLETO:  
			</h1>
			<h2 class="text-light brand mt-2  text-center">	
			...
			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  **&nbsp;Niñas: vestido apropiado (sin escotes, ni maquillajes, ni cabello pintado).</li>
