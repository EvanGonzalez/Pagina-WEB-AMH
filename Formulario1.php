    ...
    <div class="container text-center">
        <div class="contenedorform1">
            <h1 id="estilodeextoform1">
                ...
                ESCUELA SECUNDARIA ANGEL MARIA HERRERA<br>
                FICHA DE PRE-INSCRIPCION PARA 7 GRADO<br>
                PRE MEDIA
            </h1>
        </div>
        <form action="" class="formulario" id="formulario">
            ...
            <div class="formulario__grupo" id="grupo__usuario">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="nombre" id="nombre" placeholder="Escribe Nombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+" required>
            ...
            <div class="formulario__grupo" id="grupo__nombre">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="nombre" id="nombre" placeholder="Escribe Apellido" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__password">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="password" id="password" placeholder="0-000-0000" pattern="[E]{0,1}[-]{0,1}([1-9]|1PI|N|PE|10|11|12|13)[-]{1}[0-9]{1,4}[-]{1}[0-9]{1,4}" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__telefono">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="telefono" id="telefono" placeholder="6000-0000" pattern="[6]{1}[0-9]{3}[-]{1}[0-9]{4}" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__password2">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input nom" name="password2" id="password2" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__correo">
                ...
                <div class="formulario__grupo-input">
                    <input type="email" class="formulario__input nom" name="correo" id="correo" placeholder="Ejemplo@meduca.edu.pa" title="Utilice el correo institucional @meduca.edu.pa" type="email" pattern=".+@[mM][eE][dD][uU][cC][aA][.][eE][dD][uU][.][pP][aA]" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__password2">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="password2" id="password2" placeholder="Escribe Nombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error">Ambas contraseñas deben ser iguales.</p>
            </div>
            ...
            <div class="formulario__grupo" id="grupo__password2">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="password2" id="password2" placeholder="Escribe Apellido" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error">Ambas contraseñas deben ser iguales.</p>
            </div>
            ...
            <!-- Grupo: Teléfono -->
            <div class="formulario__grupo" id="grupo__telefono">
                <label for="telefono" class="formulario__label"><br>Celular</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="telefono" id="telefono" placeholder="6000-0000" pattern="[6]{1}[0-9]{3}[-]{1}[0-9]{4}" required>
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__password2">
                ...
                <div class="formulario__grupo-input">
                    <input type="date" class="formulario__input" name="password2" id="password2" value="<?php echo date("Y-m-d"); ?>" min="<?php echo date("Y-m-d"); ?>" max="<?php echo date("Y-m-d"); ?>">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error">Ambas contraseñas deben ser iguales.</p>
            </div>
