            ...
            <div class="col-12">
                <div class="card my-4" style="background-color: #121b4f; color: white;">
                    ...
                    <div class="card-body">
                        ...
                        <center><img src="img/IMG_5982.JPG" alt="" width="100%"></center><br>
                            <p class="textopagina2" id="justify">
        ...
        <div class="row text-center">
            <div class="col-12">
                <div class="card my-4" style="background-color: #121b4f; color: white;">
                    ...
                    <div class="card-body">
                        <!--foto de los colaboradores-->
                        <center><img src="img/IMG_5971.JPG" alt="" width="100%"></center><br>
                        Profesor Jorge Marín, , , , Magister Erica Arias Quiroz, , .
                    </div>
                </div>
            </div>
        </div>
