        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 wow fadeInLeft">
                        ...
                        <br>             
                    <div class="img2">
                        <img src="../Otras Actividades/img/folklor/Sin_imagen_disponible.jpg" alt="" class="img-fluid">                        
                    </div>
            ...
            <div class="card border-dark mb-3 wow fadeInLeft" style="width: 100%;">
                ...
                <div class="col-md-6 wow fadeInLeft">
                    <div class="card border-dark mb-3 wow fadeInLeft" style="width: 100%;">
                        <div class="card-header">Bailes y Vestuarios</div>
                        <div class="card-body text-dark">
                            <h5 class="card-title">Bailes y Vestuarios</h5>
                            <p class="card-text">
