                ...
                <div class="col-md-12">
                    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                        <ol class="carousel-indicators">
                            ...
                            <li data-bs-target="#carouselId" data-bs-slide-to="2" aria-label="Thirt slide"></li>
                    ...
                    <br>
                    <p class="wow fadeInUp">
                        Actualmente los estudiantes del Club de Robótica Angelino, se encuentran trabajando para su participación en VIII Competencia RoboCupJunior Panamá 2022 y 
                        el VI Torneo RoboTIC, este proyecto organizado por la Secretaría Nacional de Ciencia Tecnología e Innovación tiene un enfoque de proporcionar un entorno práctico 
                        y con andamios donde los estudiantes puedan crecer expandiendo sus conocimientos, despertar su curiosidad y aumentar su comodidad con la tecnología. La competencia 
